...
![git-commands](https://user-images.githubusercontent.com/90227944/138566464-25d27cbe-06f7-4605-8f29-90cdc23772be.png)
...
Course 01 🚀    | Course 02 🚀 🚀 
-----------------------------------  | ---------------  
 `Configurações de usuário`	      | **Commits** 🔓 
 `Criação de um repositório local`      |  *Obtendo alterações de um repositório remoto* 🔓
 `Versionamento` 			      | *Lidando com erros não rápidos* 🔓
 `Funcionamento do Git`		      | *Dividindo uma subpasta em um novo repositório* 🔓
 `Visualizar alterações` 		      | *Sobre mesclagens de sub árvore Git* 🔓
...
##### Setar email
	git config --global user.email joao@software-ltda.com.br
